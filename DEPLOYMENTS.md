...
Primary domain: https://wenmingwu.com  
Alias: https://www.wenmingwu.com
...
| v1.1.1 | 2026-08-27 | `c1747ba` | Preview asset and aspect-ratio corrections, mobile spacing and overflow refinements, plus stable hero-card rendering for WeChat and Quark webviews. |
| v1.1.0 | 2026-08-27 | `547f442` | Mobile adaptation update: unified responsive typography and information gutters, full-topbar tap expansion, tap-driven hero card interaction, and improved footer spacing. |
| v1.0.0 | 2026-08-26 | `b7931bf` | Initial recorded production release. Cloudflare Pages deployment, custom domains, HTTPS, and `www` redirect are active. |

Release tags use the format `site-vMAJOR.MINOR.PATCH`.
